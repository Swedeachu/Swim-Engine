...
namespace Swim::Render
{
	struct GpuMeshLod
	{
		std::uint32_t FirstIndex = 0; // Absolute index within the mesh's index page.
	...
	// pulling base), FirstIndex in indices, MeshletOffset in bytes. A row whose
	// IndexCount and VertexCount are zero is empty. Page ids index the pages that
