...
namespace Swim::RhiVulkan
{
	...
	VulkanResourceState GetBufferState(const Rhi::BufferDesc& desc, Rhi::ResourceState state)
	{
		...
		add(Rhi::ResourceState::Common, Rhi::BufferUsage::None, VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT,
		...
		add(Rhi::ResourceState::CopyDestination, Rhi::BufferUsage::TransferDestination, VK_PIPELINE_STAGE_2_COPY_BIT,
			VK_ACCESS_2_TRANSFER_WRITE_BIT);
		add(Rhi::ResourceState::VertexBuffer, Rhi::BufferUsage::Vertex, VK_PIPELINE_STAGE_2_VERTEX_ATTRIBUTE_INPUT_BIT,
		...
		add(Rhi::ResourceState::UniformBuffer, Rhi::BufferUsage::Uniform, VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT,
			VK_ACCESS_2_UNIFORM_READ_BIT);
		add(Rhi::ResourceState::ShaderRead, Rhi::BufferUsage::Storage, VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT,
			VK_ACCESS_2_SHADER_STORAGE_READ_BIT);
		add(Rhi::ResourceState::ShaderWrite, Rhi::BufferUsage::Storage, VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT,
			VK_ACCESS_2_SHADER_STORAGE_WRITE_BIT);
		add(Rhi::ResourceState::IndirectArgument, Rhi::BufferUsage::Indirect, VK_PIPELINE_STAGE_2_DRAW_INDIRECT_BIT,
	...
	VulkanResourceState GetTextureState(const Rhi::TextureDesc& desc, Rhi::ResourceState state)
	{
		...
		case static_cast<std::uint32_t>(Rhi::ResourceState::ShaderRead):
			...
			result = { VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT, VK_ACCESS_2_SHADER_SAMPLED_READ_BIT,
				(Rhi::IsDepthFormat(desc.PixelFormat) && HasTextureUsage(desc.Usage, Rhi::TextureUsage::DepthStencilAttachment))
		...
		case static_cast<std::uint32_t>(Rhi::ResourceState::ShaderRead | Rhi::ResourceState::ShaderWrite):
			...
			result = { VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT, VK_ACCESS_2_SHADER_STORAGE_READ_BIT | VK_ACCESS_2_SHADER_STORAGE_WRITE_BIT,
				VK_IMAGE_LAYOUT_GENERAL };
			break;
		case static_cast<std::uint32_t>(Rhi::ResourceState::ColorAttachment):
			...
			result = { VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT,
				VK_ACCESS_2_COLOR_ATTACHMENT_READ_BIT | VK_ACCESS_2_COLOR_ATTACHMENT_WRITE_BIT, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL };
			break;
		...
		if ((Rhi::EnumAnd(desc.Usage, usage) != usage) ||
			...
			(Rhi::HasAny(state, Rhi::ResourceState::DepthStencilRead | Rhi::ResourceState::DepthStencilWrite) &&
				!Rhi::IsDepthFormat(desc.PixelFormat)))
		{
