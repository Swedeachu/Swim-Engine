...
namespace Swim::RhiVulkan
{
	...
	VkDescriptorImageInfo BuildVulkanImageDescriptor(
		const std::shared_ptr<VulkanDeviceState>& state, const Rhi::DescriptorBindingDesc& binding, const Rhi::DescriptorWrite& write)
	{
