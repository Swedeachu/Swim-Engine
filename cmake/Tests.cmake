...
function(swim_configure_tests)
	...
	if(TARGET SwimRhiSmokeShaders)
		...
		target_compile_definitions(SwimTests PRIVATE
			...
			SWIM_RHI_PUSH_CONSTANTS_SPIRV_PATH="${SwimRhiPushConstants_SPIRV}"
			...
			SWIM_RHI_NESTED_PARAMETERS_SPIRV_PATH="${SwimRhiNestedParameters_SPIRV}"
			SWIM_RHI_NESTED_PARAMETERS_REFLECTION_PATH="${SwimRhiNestedParameters_REFLECTION}"
			SWIM_RHI_NESTED_GRAPHICS_REFLECTION_PATH="${SwimRhiNestedGraphics_REFLECTION}"
			SWIM_RHI_DEPTH_SAMPLING_SPIRV_PATH="${SwimRhiDepthSampling_SPIRV}"
			SWIM_RHI_DEPTH_SAMPLING_REFLECTION_PATH="${SwimRhiDepthSampling_REFLECTION}"
			...
			SWIM_RHI_DESCRIPTOR_ARRAYS_REFLECTION_PATH="${SwimRhiDescriptorArrays_REFLECTION}"
			SWIM_RHI_SCOPED_COMPUTE_SPIRV_PATH="${SwimRhiScopedCompute_SPIRV}"
			SWIM_RHI_SCOPED_COMPUTE_REFLECTION_PATH="${SwimRhiScopedCompute_REFLECTION}"
			SWIM_RHI_SCOPED_GRAPHICS_REFLECTION_PATH="${SwimRhiScopedGraphics_REFLECTION}"
			...
			SWIM_RHI_STANDARD_PBR_SPIRV_PATH="${SwimRhiStandardPbrProbe_SPIRV}"
			SWIM_RHI_STANDARD_PBR_REFLECTION_PATH="${SwimRhiStandardPbrProbe_REFLECTION}"
			SWIM_RHI_STANDARD_MATERIAL_DRAW_SPIRV_PATH="${SwimRhiStandardMaterialDraw_SPIRV}"
